...
hl.bind("SUPER + M",      hl.dsp.window.fullscreen_state({ internal = 2, client = 0, action = "toggle" }))
hl.bind("SUPER + F",      hl.dsp.layout("fit visible"))
...
hl.bind("SUPER + P", hl.dsp.layout("consume_or_expel prev"))
hl.bind("SUPER + SHIFT + P", hl.dsp.layout("consume_or_expel next"))
